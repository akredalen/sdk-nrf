...
/* Thread is preemptible, and will publish button events to zbus*/
#define BUTTON_PUBLISH_THREAD_PRIO 5

#define BUTTON_PUBLISH_STACK_SIZE 450
...
K_THREAD_DEFINE(button_publish, BUTTON_PUBLISH_STACK_SIZE, button_publish_thread, NULL, NULL,
		NULL, K_PRIO_PREEMPT(BUTTON_PUBLISH_THREAD_PRIO), 0, 0);
