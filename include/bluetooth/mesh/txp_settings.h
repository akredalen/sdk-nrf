...
#define TXP_MODEL_CH_ADDR 0xC000
...
#define BT_MESH_DEVICE_TXP_SET_ACK_OP BT_MESH_MODEL_OP_3(0xC2, BT_MESH_NORDIC_SEMI_COMPANY_ID)

#define BT_MESH_DEVICE_TXP_SET_UNACK_OP BT_MESH_MODEL_OP_3(0xC3, BT_MESH_NORDIC_SEMI_COMPANY_ID)

#define BT_MESH_DEVICE_TXP_STATUS_OP BT_MESH_MODEL_OP_3(0xC4, BT_MESH_NORDIC_SEMI_COMPANY_ID)
